...
#default df
df = pd.read_excel("parcurs_senat_2025_2025-09-05.xlsx")
...
# tag 'extract' column -start and end !!!!!To filter certain things
#start
...
#export
df.to_excel('clean_senat_pars_2025.xlsx', index= False)